package mx.com.tesoem.isc.intersemestral.archivostxt.javc;
...
public class Archivos {
    ...
    public boolean Leer(Context contexto){
        try{
            InputStreamReader archivo = new InputStreamReader(contexto.openFileInput(NomArch));
